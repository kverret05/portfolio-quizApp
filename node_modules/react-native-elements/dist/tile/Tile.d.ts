...
import { IconObject, IconProps } from 'react-native-elements/dist/icons/Icon';
...
declare const _default: React.FunctionComponent<Omit<TouchableOpacityProps & TouchableNativeFeedbackProps & {
    ...
    imageProps?: Partial<ImageProps>;
    ImageComponent?: typeof React.Component;
} & Partial<import("react-native-elements/dist/config").ThemeProps<TileProps>>, keyof import("react-native-elements/dist/config").ThemeProps<T>>> | React.ForwardRefExoticComponent<TouchableOpacityProps & TouchableNativeFeedbackProps & {
    title?: string;
    icon?: IconObject & import("react-native-vector-icons/Icon").IconButtonProps & {
        type?: string;
        Component?: typeof React.Component;
    ...
    imageProps?: Partial<ImageProps>;
    ImageComponent?: typeof React.Component;
} & Partial<import("react-native-elements/dist/config").ThemeProps<TileProps>>>;
